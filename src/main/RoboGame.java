...
public class RoboGame extends JFrame {
    ...
    private WorldComponent worldComp = new WorldComponent(world);
	...
	load1.addActionListener(new ActionListener() {@Override
		public void actionPerformed(ActionEvent e) {
		    code1 = getCodeFile();
		    if (code1!=null){
			world.loadRobotProgram(1,code1);
			worldComp.repaint();
		    }
		}
	    });
	...
	load2.addActionListener(new ActionListener() {@Override
		public void actionPerformed(ActionEvent e) {
		    code2 = getCodeFile();
		    if (code2!=null){
			world.loadRobotProgram(2, code2);
			worldComp.repaint();
		    }
		}
	    });
	...
	reset.addActionListener(new ActionListener() {@Override
		public void actionPerformed(ActionEvent e) {
		    ...
		    if(code1 != null) { newWorld.loadRobotProgram(1,code1); }
		    if(code2 != null) { newWorld.loadRobotProgram(2,code2); }
		    worldComp.reset(newWorld);
		    worldComp.repaint();
